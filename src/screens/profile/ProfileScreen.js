...
const styles = StyleSheet.create({
  ...
  backBtn: { position: 'absolute', top: Spacing.md, left: Spacing.md, width: 36, height: 36, alignItems: 'center', justifyContent: 'center' },
  backBtnText: { fontSize: Typography.sizes.xl, color: 'rgba(255,255,255,0.8)' },
